...
<nav class="gs-navbar">
	<div class="gs-nav-container">
		<ul>
			...
			<li class="active"><a href="/forums">论坛</a></li>
		</ul>
	</div>
</nav>
...
<div id="brdheader" class="block">
	<div class="box">
		<div id="brdtitle" class="inbox">
			<h1><a href="index.php">夜莺<span>慕柒</span></a></h1>
			<div id="brddesc"><p><span>夜莺慕柒中文资源论坛</span></p></div>
		</div>
		<div id="brdmenu" class="inbox">
			<ul>
				<li id="navindex" class="isactive"><a href="http://sqziyuan.xyz/home.php">主页</a></li>
				<li id="navregister" class="isactive"><a href="http://sqziyuan.xyz/member.php?action=register">注册</a></li>
				<li id="navlogin" class="isactive"><a href="http://sqziyuan.xyz/member.php?action=login">登录</a></li>
			</ul>
		</div>
...
<div id="brdfooter" class="block">
	<div class="box">
		<div class="inbox">
			<p>夜莺慕柒中文资源论坛 2020</p>
			<ul>
				<li><span><a href="tos.php">服务使用条款 / 隐私政策</a></span></li>
			</ul>
			<div class="clearer"></div>
		</div>
	</div>
